...
function validateName(name) {
    ...
    if (!regex.test(name)) {
        ...
        document.getElementById('fullName').style.borderColor = '#ff0000'; // Bright red for error
        return false;
    } else {
...
function validateEmail(email) {
    ...
    if (!regex.test(email)) {
        ...
        document.getElementById('email').style.borderColor = '#ff0000'; // Bright red for error
        return false;
    } else {
...
function validatePhone(phone) {
    ...
    if (!regex.test(phone)) {
        ...
        document.getElementById('phone').style.borderColor = '#ff0000'; // Bright red for error
        return false;
    } else {
...
function validatePassword(password) {
    ...
    if (!regex.test(password)) {
        ...
        document.getElementById('password').style.borderColor = '#ff0000'; // Bright red for error
        return false;
    } else {
